...
class EventManagementSystem{
    ...
    public function addEvent($events, $organizer_id, $conn){
        ...
        $stmt->bind_param("ssssssssi", $events->title, $events->location, $events->date, $events->start_time, $events->end_time, $events->capacity, $events->description, $events->organizer_id);
